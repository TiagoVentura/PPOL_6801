...
## this is not the main estimation technique we saw in class. 
## But it is a efficient way, similar to the Glove algorithm, for you to
## estimate embeddings locally. More importanly,
## by estimating your embeddings step by step, 
## I think you will get a better sense 
...
# Let's write a function to get the nearest neighbors
...
# 2 - Train your local word embedding: GloVe and Word2Vec --------------------
...
# - See the python code for more on the papers we saw in class
...
# Better results on accuracy and precision, but not as good as in recall, 
## all of this with a much denser matrix. 

...
-   [Count-based methods]{.red}: look at how often words co-occur with neighbors.
    ...
    -   This approach is implemented by the "GloVE" algorithm
...
-   [GloVe]{.red} are trained on different things: Wikipedia (2014) + Gigaword (6B words), Common Crawl, Twitter. And uses a co-occurence matrix instead of Neural Networks (More about that later today)

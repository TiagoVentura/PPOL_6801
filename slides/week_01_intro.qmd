...
**In the past 20 years, we have been going through a digital revolution:**
...
-  Focuses on using text as a form of data to make inferences about the world around us, such as human behavior

-   This class covers: 

    - Computational methods to process and analyze text at scale ([Data Science]{.red})
...
# But... why do I need an entire course for this? Isn't my stats/DS class enough?
...
-   Existing corpora; scraped data; digitilized text
:::
...
- If not, happy to share code for you to learn 

    - I know DSPP student saw this last fall with me!!
...
-   On your poragrams,you learn a lot of DS/Stats techniques 
...
-   If you have a dataser you want work with, please bring it to class!

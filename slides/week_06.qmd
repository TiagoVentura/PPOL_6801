...
-   [Problem Set 1]{.red}
    ...
    -   Issues with GitHub: update of PAT. You probably do not have permission to post on a forked repo. 
    -   Grades to be posted soon
...
-   [Goal:]{.red} take the observations and find [hidden structure]{.red} and meaning in them
...
knitr::include_graphics("./week6_figs/kmeans5.png") 
...
For each document (and then topic) \~ Randomly choose a distribution from a multinomal distribution
...
## Exercise: Plate Notation {visibility="hidden"}
...
# Quick survey: click [here](https://forms.gle/evAYeWPzgrzrWtpi9)

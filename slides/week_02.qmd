...
#```{r fig.align="center"}
knitr::include_graphics("week2_figs/ventura_jqd.png")
#```
...
-   Descriptive paper
    ...
    -   No complicated statistical model

    -   Nice data + theory + contextual knowledge

-   An clever example of using text to measure a latent outcome (Political power)

-   TaD + Metadata \~ Most applied social science papers will consist of this combination

-   Simple quantity of interest: just by counting words.

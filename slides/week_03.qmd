...
You have your pairs for the replication exercise [Next steps]{.red}:
...
-   $||\mathbf{U}||$ \~ vector magnitude, length \~ $\sqrt{\sum{y_{U_i}^2}}$
...
- [authors with limited vocabularies will have a low lexical diversity]{.midgray}
:::

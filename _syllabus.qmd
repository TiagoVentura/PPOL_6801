...
**Tip on readings:** This class follows a PhD-style Seminar. This means I expect you to read the materials before class. This is my suggestion for you to optimize your reading time: 1) read very carefully the chapters from the textbook; 2) skim through the applied paper, and focus most of your attention to methods and results from the applied papers -- theory and literature review of these papers are less relevant for us.

...
Data science is an applied field. For this reason, it is fundamental that you understand how to conduct a complete analysis from collecting data, to cleaning and analyzing it, to presenting your findings.
...
The project proposal asks that you ske`tch out a general 2 page (single-spaced; 12pt font) project proposal. The proposal should offer the following information:
